...
def new_posts_for_week_in_category():
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        scheduler.add_job(
            new_posts_for_week_in_category,
            trigger=CronTrigger(day_of_week="mon", hour="00", minute="00"),  # Every 10 seconds
            id="new_posts_for_week_in_category",  # The `id` assigned to each job MUST be unique
            max_instances=1,
